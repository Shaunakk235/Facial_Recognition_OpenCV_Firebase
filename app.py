...
#Github: https://github.com/Shaunakk235
...
class SimpleFacerec:
    def __init__(self):
        #Download Json File Of Your Own
        cred = credentials.Certificate(r'path of ServiceAccountKey.json') #add your own file path
        firebase_admin.initialize_app(cred, {'databaseURL': "firebase URL"}) #add your own firebase URL
